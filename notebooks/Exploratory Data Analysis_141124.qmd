...
subfolder <- "/cloud/project/tables/mean&median_tables"
...
# load cpg-data
cpg <- read.table(file = '/cloud/project/tables/Ausgangstabellen/cpg.txt', sep = "\t", header = TRUE, row.names = NULL, quote = "")
...
# Folder where the files are located
subfolder_wide <- "/cloud/project/tables/wide_format/"
