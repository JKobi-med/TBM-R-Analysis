...
### Boxplots
```{r}
cpg <- read.table(file = '/Users/kobi/Desktop/Promotionsdatananalyse mit Excel und Martin/Promotion (Quarto Manuscript)/tables/cpg.txt', sep = "\t", header = TRUE, row.names = NULL, quote = "")
