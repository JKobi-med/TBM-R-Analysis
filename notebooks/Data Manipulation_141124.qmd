...
# load data
 ## BDNF
bdnf <- as_tibble(read.table('/cloud/project/tables/Ausgangstabellen/bdnf.txt', 
                   sep = "\t", 
                   header = TRUE, 
                   row.names = NULL, 
                   quote = ""))
head(bdnf)
 ...
 ##Tau
tau <- as_tibble(read.table('/cloud/project/tables/Ausgangstabellen/tau.txt', 
                   sep = "\t", 
                   header = TRUE, 
                   row.names = NULL, 
                   quote = ""))
head(tau)
 ...
 ## PSD95
psd95 <- as_tibble(read.table('/cloud/project/tables/Ausgangstabellen/psd95.txt', 
                   sep = "\t", 
                   header = TRUE, 
                   row.names = NULL, 
                   quote = ""))
...
cpg <- as_tibble(read.table(file = '/cloud/project/tables/Ausgangstabellen/cpg.txt', 
                  sep = "\t", 
                  header = TRUE, 
                  row.names = NULL, 
                  quote = ""))
