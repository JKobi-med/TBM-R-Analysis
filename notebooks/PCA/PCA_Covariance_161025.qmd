...
# Assume pca_bdnf_res is already computed
autoplot(
  pca_bdnf_res,
  data = na.omit(bdnf[c(1:22)]),  # metadata
  colour = 'Gruppe',               # color by group
  shape = 'Sex',                   # shape by Sex
  size = 'Age_start',              # size by Age_start (numeric)
  loadings = TRUE,                 # show variable loadings
  loadings.colour = 'blue',
  loadings.label = TRUE,
  loadings.label.size = 3
) +
  theme_bw() +
  ggtitle("BDNF PCA Colored by Group, Shape by Sex, Size by Age")
